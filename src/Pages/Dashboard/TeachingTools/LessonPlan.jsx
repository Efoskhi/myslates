  ...
  return (
    <div>
      ...
      <div className="flex flex-col lg:flex-row gap-6 p-6 min-h-screen">
        ...
        <div className="bg-white p-6 shadow-lg rounded-lg w-full lg:w-1/3">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <select
                name="term"
                value={inputs.lessonPlan.term}
                onChange={e => handleInput("lessonPlan.term", e.target.value)}
              ...
              <select
                name="week"
                value={inputs.lessonPlan.week}
                onChange={e => handleInput("lessonPlan.week", e.target.value)}
                className="border rounded-lg p-2 w-full"
              >
            ...
            <select
              name="grade"
              value={inputs.lessonPlan.grade}
              onChange={e => handleInput("lessonPlan.grade", e.target.value)}
              className="border rounded-lg p-2 w-full"
            >
            ...
            <select
              name="subject"
              value={inputs.lessonPlan.subject}
              onChange={e => handleInput("lessonPlan.subject", e.target.value)}
              className="border rounded-lg p-2 w-full"
            >
            ...
            <input
              type="number"
              name="duration"
              value={inputs.lessonPlan.classDuration}
              onChange={e => handleInput("lessonPlan.classDuration", e.target.value)}
            ...
            <input
              type="text"
              name="topic"
              value={inputs.lessonPlan.description}
              onChange={e => handleInput("lessonPlan.description", e.target.value)}
        ...
        >
          <GeneratedQuestions 
            onRegenerate={handleGenerateLessonPlan} 
            generatedResponse={generatedResponses.lessonPlan} 
            isLoading={isLoading}
