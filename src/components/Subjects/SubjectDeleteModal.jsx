...
const SubjectDeleteModal = ({ toggleModal }) => {
    const { isSaving, handleDeleteSubject } = useSubject();

    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-1000" style={{zIndex: 200}}>
            {/* Modal Content */}
            <div className="bg-white rounded-lg p-6 w-full max-w-md m-4 relative">
                ...
                <p className="text-md font-semibold text-gray-700 dark:text-gray-300 bg-blue-100 dark:bg-blue-900 p-4 rounded-lg border border-blue-300 dark:border-blue-700 shadow-md">
                    Are you sure you want to delete this subject and associated
                    lesson, quizes and assignments?
                </p>
